...
import UpdateValidator from 'App/Validators/Post/Reactions/UpdateValidator'
...
export default class ReactionsController {
  public async update({request, auth}: HttpContextContract) {
    ...
    const reaction = await post.related('reactions').updateOrCreate({postId, userId: auth.user!.id}, {type})
